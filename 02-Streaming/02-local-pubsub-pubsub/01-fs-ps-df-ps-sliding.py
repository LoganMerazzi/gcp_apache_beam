...
pipeline_options = {
    ...
    'template_location': 'gs://bkt-estudo-beam/template/streaming-sliding',
...
Tempo_Atrasos = (
    ...
    | "(Tempo) Window" >> beam.WindowInto(window.SlidingWindows(10,5))
...
Qtd_Atrasos = (
    ...
    | "(Qtd) Window" >> beam.WindowInto(window.SlidingWindows(10,5))
